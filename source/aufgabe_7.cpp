...
TEST_CASE("sorted") {
    ...
    auto sortRuleLambda = [] (const Circle& c1, const Circle& c2) -> bool
    {
       return c1.getRadius() < c2.getRadius();
    };

    sort(sorted_circles.begin(), sorted_circles.end(), sortRuleLambda); //I guess this answers my question in 6
